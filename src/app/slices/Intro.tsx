      ...
      >
        ...
        >
          <Text variant="body" fontWeight="bold">
            ...
            of England. With a first-class degree in Interaction Design from
            Northumbria University and six+ years experience designing for web
            and mobile.
          </Text>
          <Text variant="body">
            She’s adept at working in cross functional teams, working closely
            with product owners, delivery managers, developers and stakeholders.
            Having worked with in sectors from fintech to cheese-tech Jo is a
            dab hand at all things interface and experience.
          </Text>
          <Button
            variant={"primary"}
            ml="auto"
